    ...
    in
    {
      programs.vscode = {
        ...
        profiles.default = {
          ...
          userSettings = {
            "editor.fontFamily" = "'${config.font.monospace.name}', 'Droid Sans Mono', 'monospace', monospace";
            ...
            "vscode-neovim.neovimInitVimPaths.linux" = "/home/tarek/.config/vscode/init.lua";
